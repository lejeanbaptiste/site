...
# Le catalogue de vos entités.

Vous avez balisé un nom, puis identifié la personne, le lieu ou l’œuvre auquel il renvoie. Grognard conserve cette décision dans une **base d’entités** : un catalogue de personnes, lieux, œuvres, fonctions, dates et autres objets de votre édition, avec leurs variantes, leurs notes et leurs liens d’autorité.

Cette page ne reprend pas la procédure de balisage et de désambiguïsation. Elle explique où vivent les identifiants que vous avez créés, comment entretenir leur catalogue et comment garder ce catalogue en accord avec vos textes.
